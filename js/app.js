          ...
          m.autoZenkai !== false
            ? el('div', { style: 'margin:2px 0 6px 22px' },
                ...
                el('p', { class: 'small-note' },
                  ...
                  + '合計だけで選ぶとZアビの大きい非ZENKAIキャラが枠を占めることがあります。'
                  + 'さらに ZENKAIアビは 177体中169体（95.5%）が打撃と射撃の両方をほぼ同量上げる構造なので、'
                  + '片側特化のプリセットでは攻撃分の約半分が評価されません。'
                  + 'そのぶんZENKAI覚醒キャラが不利になるため、既定で「ZENKAI覚醒キャラだけから選ぶ」を入れています（§45）。'))
            : null)
      : null,
    el('label', { class: 'check' },
      el('input', {
